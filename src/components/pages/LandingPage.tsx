...
export function LandingPage({
  ...
  const [isEmailVerified, setIsEmailVerified] = useKV(
    "auth.email-verified",
    false
  );
  ...
  const handleEmailVerification = () => {
    ...
    toast.success(
      "Email verified successfully! You can now select an identity provider."
    );
  };
              ...
              {!waitingForVerification ? (
                <>
                  <div className="space-y-2">
                    <Label
                      htmlFor="email"
                      className="text-[rgb(64,143,204)] font-medium"
                    >
                      Email Address
                    </Label>
                    <Input
